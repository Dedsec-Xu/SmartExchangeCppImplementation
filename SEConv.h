...
public:
    ...
    int kaiming_uniform_(fixed input_matrix[][][], int dimensions, int size_1, int size_2, int size_3);
    int uniform_(fixed input_matrix[][][], float lower_bound, float upper_bound, int size_1, int size_2, int size_3);
    int normal_(fixed input_matrix[][][], float mean_in, float std_in, int size_1, int size_2, int size_3);
    fixed gaussrand();
    void set_mask();
    void get_weight(fixed Ce_buffer[][][], fixed B_buffer[][][], fixed weight[][][][]);
    void forward(fixed Ce_buffer[][][], fixed B_buffer[][][], fixed weight[][][][]);
