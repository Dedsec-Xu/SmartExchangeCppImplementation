'''
 ...
 # @ Create Time: 2019-05-26 23:54:10
 # @ Modified by: Xiaohan Chen
 # @ Modified time: 2019-05-27 01:46:40
 # @ Description:
 '''
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False):
        ...
        # self.conv1 = SEConv2d(3, 64, kernel_size=7, stride=2, padding=3,
                               bias=False)
        ...
        self.fc = SELinear(512 * block.expansion, num_classes, threshold=THRESHOLD)
