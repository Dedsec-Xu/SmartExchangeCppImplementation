...
float SEbackward(float Ce_buffer[][BF_CE_2][BF_CE_3], float loss, float max_C, float min_C, float qC_buffer[][BF_CE_1][BF_CE_1], int size_C_dim[], float Learning_Rate, float mask_data_buffer[][BF_CE_1][BF_CE_1], float threshold)
{
...
int reshapeBC(float input1[][buffersize_x][buffersize_y], float output[][buffersize_x][buffersize_y][buffersize_y], int inputdim[], int dim_1, int dim_2, int dim_3, int dim_4)
{
    int input_d1, input_d2, input_d3, input_d, input_d1X2, in_iter_1, in_iter_2, in_iter_3;
    input_d1 = inputdim[0];
    input_d2 = inputdim[1];
