...
SEConv(bool bn, bool relu, int batch_size, int ch_in, int ch_out, int size_in, int size_out, int kernel_size, int stride, int padding, float *conv_in, float *weights, float *bias, float *conv_out, int size_splits, float threshold, int size_C_dim[],  int size_B_dim[], float Ce_buffer[], float B_buffer[]);
