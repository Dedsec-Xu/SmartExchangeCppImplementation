...
float SEbackward(float Ce_buffer[][BF_CE_2][BF_CE_3], float loss, float max_C, float min_C, float qC_buffer[][BF_CE_1][BF_CE_1], int size_C_dim[], float Learning_Rate,
    float mask_data_buffer[][BF_CE_1][BF_CE_1], float threshold);
